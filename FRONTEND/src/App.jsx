...
import ComplaintDetailWithMap from "./pages/COMPLAINT_DETAIL_WITH_MAP.jsx";
import HotspotExplorer from "./pages/HOTSPOT_EXPLORER.jsx";
      ...
      <div className="app-shell">
        ...
        <main className="page-shell">
          <Routes>
            ...
            <Route path="/hotspots/:hotspotId" element={<HotspotExplorer />} />
            <Route path="/complaint/:id" element={<ComplaintDetails />} />
            <Route path="/complaint-map/:id" element={<ComplaintDetailWithMap />} />
          </Routes>
        </main>
        <Footer />
      </div>
